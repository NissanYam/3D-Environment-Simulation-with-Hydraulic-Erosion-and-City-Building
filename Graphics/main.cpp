...
void DrawWall(int x_start, int z_start, int x_end, int z_end, double average_height)
{
	...
	glBegin(GL_POLYGON);
	glTexCoord2d(0, 0);		glVertex3d(z_start - GSZ / 2, ground[x_start][z_start], x_start - GSZ / 2);

	glTexCoord2d(0, 2);		glVertex3d(z_end - GSZ / 2, ground[x_end][z_end], x_end - GSZ / 2);

	glTexCoord2d(4, 2);		glVertex3d(z_end - GSZ / 2, average_height, x_end - GSZ / 2);

	glTexCoord2d(4, 0);		glVertex3d(z_start - GSZ / 2, average_height, x_start - GSZ / 2);
